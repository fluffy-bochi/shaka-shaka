...
const PERSONAS = [
  {
    ...
    slots: [
      ...
      { emoji: '☀️', name: '午前', records: [
        { g: '💬', t: '会議（1時間）', f: 11 },
        { g: '📝', t: '資料作成（1時間30分）', f: 17 },
      ] },
      { emoji: '🌤', name: '午後', records: [
        { g: '🍙', t: 'ランチ（30分）', f: -4 },
        { g: '⌨️', t: '集中作業（1時間40分）', f: 15 },
        { g: '💬', t: '打ち合わせ（45分）', f: 9 },
        { g: '☕', t: 'お茶（15分）', f: -2 },
      ] },
    ...
    total: 60, over: false,
    note: <>就寝前は<b>60</b>。🛏 7時間ねむって朝の申告は「すこし残ってる」＝12 → <span style={{ ...mono, color: '#7a9a00' }}>睡眠回復 −48</span>、⏰後から回復 −2。翌朝は <b style={mono}>10</b> でスタート。</>,
  },
  {
    ...
    total: 70, over: false,
    note: <>就寝前は<b>70</b>。🛏 6時間ねむって朝の申告は「どっさり」＝30 → <span style={{ ...mono, color: '#7a9a00' }}>睡眠回復 −40</span>。翌朝は <b style={mono}>30</b> でスタート。シフト3時間のバイトが1日の重さの主因。</>,
  },
  {
    ...
    slots: [
      ...
      { emoji: '☀️', name: '午前', records: [
        { g: '💬', t: '会議（1時間）', f: 12 },
        { g: '📝', t: '事務作業（1時間30分）', f: 17 },
      ] },
      { emoji: '🌤', name: '午後', records: [
        { g: '🍙', t: 'ランチ（20分）', f: -2 },
        { g: '⌨️', t: '集中作業（1時間30分）', f: 14 },
        { g: '📞', t: '電話対応（1時間）', f: 9 },
      ] },
      { emoji: '🌙', name: '夜', records: [
        { g: '🚙', t: 'お迎え（30分）', f: 5 },
    ...
    total: 105, over: true,
    note: <>就寝前は<b>105</b>＝<b>あふれ</b>。皿洗いが15分+2でも、育児・寝かしつけの積み重ねであふれは起きる。シェイカーはあふれて振れない＝この生活自体が頑張りすぎの信号（警告はしない）。🛏 6.5時間ねむって申告「どっさり」＝35 → <span style={{ ...mono, color: '#7a9a00' }}>回復 −63</span>、⏰後から回復 −5。翌朝は <b style={mono}>37</b> でスタート。</>,
  },
];
