...
const STEPS = {
  ...
  6: { pos: 'bottom', text: (f) => f.shaken
    ...
    : <>右上の <b>🔀</b> を押すとシャカシャカできます（スマホは本体を振ってもOK）。振ってみよう</>,
  nextWhen: (f) => f.shaken },
  ...
  12: { pos: 'bottom', text: (
    <>そのほかにできること:<br />
      ...
      <span style={{ display: 'block', marginTop: 6, color: '#55554e' }}>💡 Chromeだと右上の<b>︙</b>から「<b>ホーム画面に追加</b>」を押すと、もっとアプリっぽくさわれます。よかったら試してみてください。</span>
      おつかれさまでした！</>
  ), done: true },
};
